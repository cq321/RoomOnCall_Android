...
public class CalendarAdapterCheckin extends BaseAdapter {
	private Context mContext;

	private Calendar month, todayCalender, lastCalender;
	...
	public CalendarAdapterCheckin(Context c, GregorianCalendar monthCalendar,
			GregorianCalendar todayCalender, GregorianCalendar lastCalender) {
		CalendarAdapterCheckin.dayString = new ArrayList<String>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if ((Integer.parseInt(gridvalue) < (todayCalender
				.get(GregorianCalendar.DAY_OF_MONTH)))
				&& (todayCalender.get(GregorianCalendar.MONTH) == month
						.get(GregorianCalendar.MONTH))
				&& (todayCalender.get(GregorianCalendar.YEAR) == month
		...
		// if block added by binit to disable date after than last date
		...
		// if((Integer.parseInt(gridvalue)>=(lastCalender.get(GregorianCalendar.DAY_OF_MONTH)))&&
		// (month.get(GregorianCalendar.MONTH)>=lastCalender.get(GregorianCalendar.MONTH))&&
		// (month.get(GregorianCalendar.YEAR)>=lastCalender.get(GregorianCalendar.YEAR))){
		// dayView.setTextColor(Color.GRAY);
		// dayView.setClickable(false);
		// dayView.setFocusable(false);
		// dayView.setFocusableInTouchMode(false);
